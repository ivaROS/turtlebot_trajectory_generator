...
Real b3_spline(Real x)
{
    ...
    if (absx < 1)
    {
        Real y = 2 - absx;
        Real z = 1 - absx;
        return 1.66666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666667e-01*(y*y*y - 4*z*z*z);
    }
    if (absx < 2)
    {
        Real y = 2 - absx;
        return 1.66666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666667e-01*y*y*y;
    }
    return (Real) 0;
}
